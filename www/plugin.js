...
var SqlServer = {
		...
		init: function(server, instance, username, password, database, port, success, error) {
			exec(success, error, PLUGIN_NAME, 'init', [server, instance, username, password, database, port]);
		},  
